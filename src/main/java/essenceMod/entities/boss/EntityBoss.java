...
public class EntityBoss extends EntityMob implements IBossDisplayData // Not implemented yet, please ignore
{
	...
	public static final int PLAYER_RANGE = 15;
	public static final int ARENA_RANGE = 11;
	...
	private static final String TAG_ATTACKS = "Attacks";
	...
	/**
	 * Default diameter, in blocks, of a Flameblast
	 */
	public static final int FB_DEF_SIZE = 9;
	/**
	 * Default damage (in half hearts) of a Flameblast
	 */
	public static final int FB_DEF_DMG = 10;
...
//			if (!hasProperArena(world, pos, player)) return false;
	...
	public boolean attackEntityFrom(DamageSource source, float amount)
	{
		...
		if (source.getDamageType().equals("player") && source.getClass().equals(EntityDamageSource.class)) amount = 0;
	...
	public void onLivingUpdate()
	{
		...
		if (worldObj.isRemote) BossStatus.setBossStatus(this, false);
